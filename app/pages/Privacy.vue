...
<template>
  <div class="py-12 px-10 container mx-auto">
    ...
    <h2 class="mt-10">
      ...
      used, and shared when you visit or make a purchase from rongta.com.bd
    </h2>

    <h2 class="font-semibold py-8">PERSONAL INFORMATION WE COLLECT</h2>
    ...
    <h2 class="py-4">HOW DO WE USE YOUR PERSONAL INFORMATION?</h2>
    <p>
    ...
    <h2 class="py-4">SHARING YOUR PERSONAL INFORMATION</h2>
    <p class="py-4">
    ...
    <h2 class="py-4">BEHAVIOURAL ADVERTISING</h2>
    ...
    <h2 class="py-4">DATA RETENTION</h2>
    <p class="py-4">
      When you place an order through the Site, we will maintain your Order
      Information for our records unless and until you ask us to delete this
      information.
    </p>
    <h2 class="py-4">CHANGES</h2>
    <p>
